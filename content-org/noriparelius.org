...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_walk-like-aragorn.webp :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_kegel_or_not_kegel.webp :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_movement-moves-the-brain.webp :f_alt "A watercolor of a brain" :summary "As a teenager I used to always listen to music or audiobooks when I went for a run. I did it because running and exercise were a chore - a boring, annoying, but necessary chore. I didn't do it for the fun of it. It's common to see exercise as a chore that we just want to get over with, but today I will tell you about all the reasons why a focused movement practice is good for not only your body, but also your brain. " :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_move-more-move-better.webp :f_alt "A photograph of a wooden bridge over a stream with trees around." :summary "I used to be a nerdy little bookworm as a kid and as a teenager. And honestly a bit of a couch potato. If I could sit in a comfy armchair with a book, I would sit in a comfy armchair with a book. I never really decided not to move - but it was happening and it had consequences." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_carnivore.webp :f_alt "A close up of a raw steak" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_failed-online-business.webp :f_alt "An image with a computer screen in the middle and two hands exchanging a credit card and a shopping bag in front of it." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_bodies-trying-kill-us.webp :f_alt "An image of a big stick of butter." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_blind-spot.webp :f_alt "A close-up of a pile of white crystalline substance." :summary "For the longest time, I didn't want to admit it to myself. I thought I was in control. I thought I was "moderating", whatever that might mean. But in truth I was moderating myself to a serving of my drug of choice dozens of times every day. Simply because I wouldn't feel good without it. Simply because I wanted it. A lot." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_ode-to-gait.webp :f_alt "A photograph of a toddler in blue rain gear walking away from the camera." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_brain-hacking.webp :f_alt "Image of a blue and white network as an artistic depiction of brain connections." :summary "I have been struggling with sugar addiction for years. And just like it tends to be with addictions, it was a very tough battle, and I wasn't always winning. I was ready to fight for the rest of my life, but now I think I might not have to." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_natural-human-diet.webp :f_alt "A photograph of a plastic mammoth on a wooden bench in front of a lake." :summary "Pandas eat bambus, koalas eucalyptys. Humans are probably the only creatures in the world that are confused about what they should be eating. What are we meant to eat? What is the natural human diet?" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_my-reasons-for-blogging.webp :f_alt "An AI generated watercolor image of a platypus in front of a laptop." :summary "As I was starting yet another blog (this one), I decided to be a bit more mindful and conscious of what my goals actually are. Because if you don't know where you want to go, every step you take is in the wrong direction. So here are my 5 reasons for blogging!" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_my-year-with-zettelkasten.webp :f_alt "An image of a graph of a few hundred nodes of different colours connected with lines." :summary "It is almost a tradition for people who get hooked on Zettelkasten to write a blog post about it. After using it for a year, I think it is about time I followed this tradition and added my experiences." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_happiness-not-on-social-media.webp :f_alt "A collage of photographs of various scenes, from landscapes, through animals, people, war scenes, close ups etc, with a sad emoji in the middle." :summary "We go there to see things we (mostly) didn't choose ourselves, served to us in small bite-sized bits: *-- an interesting fact! -- a sad story :( -- an update from a "friend" you haven't talked to in 12 years -- a funny video! -- a scary thing you should look out for!!! --...* Before you get the time to digest one, you move onto the next. Over and over again. Scroll, scroll, scroll." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_what-can-you-do-for-nature.webp :f_alt "A blurry image of a meadow with a few plants in focus in the forground." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_grow-life-not-economy.webp :f_alt "" :layout "single-post"
:EXPORT_DATE: 2023-12-31
:END:
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_way-out-of-burnout.webp :f_alt "An image of standing matchsticks with one in the middle being burnt and black." :summary "I haven't been feeling like myself for the last 5 months. Actually, that is a bit of an understatement." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_habit-trackers.webp :f_alt "A graphics of a checkbox with a big X drawn inside." :summary "Habit trackers seem like the perfect solution for when you want to build or maintain a habit. Yet, they stopped working for me (if they ever really worked at all) and so I have finally stopped using them. Thankfully, I figured out better ways of making my new habits stick." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_creativity.webp :f_alt "A graphics of four colorful beetles seen from above walking over a black and white striped surface that looks like a pedestrian crossing." :bsky "https://bsky.app/profile/nori-pareli.bsky.social/post/3lerbqr6g622b" :summary "My husband and I have been watching *The Beatles: Get Back* documentary and it made me think a lot about creativity, art and authenticity." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_science.webp :f_alt "" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_soft.webp :f_alt "A closeup image of a feather" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_phones.webp :f_alt "An image of a smartphone with a magicians hat on the screen and fireworks coming out of it." :bsky "https://bsky.app/profile/nori-pareli.bsky.social/post/3lfayckai6s2i" :summary "Knowing we are being affected doesn't stop us from being affected, just like knowing a magic trick isn't real magic doesn't stop us from being tricked. But, if nothing else, I find it easier to manage my phone use knowing what I am up against and what it is about the smart phone that makes it difficult to moderate. So here are the three ways in which the smartphones mess with us." :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_goodbye-zettelkasten.webp :f_alt "A photograph of a trail through a summer birch forest" :bsky "https://bsky.app/profile/nori-pareli.bsky.social/post/3lng364ookk2u" :summary "When I first heard about the Zettelkasten (ZK) method, it seemed like the Holy Grail of note-taking. One place to put all my thoughts, all my ideas, all the things I am learning and would wish to remember? One place to *always* find them? One place to bring them all... *and in the darkness bind them*? I mean: bring them all together?" :layout "single-post"
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_knowledge-play.webp :f_alt "A painting of a fountain pen leaving an ink stain." :layout "single-post" 
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_ai-left.webp :f_alt "A drawing of a left hemisphere of the brain, with some circuitry next to it and lines slashing across both." :layout "single-post" 
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_agency.webp :f_alt "Drawing of a slightly open door." :layout "single-post" 
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_jonathan-strange-mr-norrell.webp :f_alt "Cover of Jonathan Strange and Mr Norrell - a novel by Susanna Clarke, featuring a white silhouette of raven on black background." :layout "single-post" 
...
:PROPERTIES:
:EXPORT_FILE_NAME: _index
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_alphabet-superset.webp 
:END:
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_A.webp :f_alt "Sleeping Beauty by Edward Frederick Brewtnall. A romantic painting of a woman with long light hair in a white dress sleeping surrounded by flowers. A man is looking at her from a little distance. The woman has cartoonish pink headphones added, while the man has a green baseball cap and a scooter standing next to him." :layout 'single-alphabet-superset'
:EXPORT_DATE: 2024-09-02
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_B.webp :f_alt "A painting of an oldschool big metal key by Edna C. Rex with drops of blood added." :layout 'single-alphabet-superset'
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_C.webp :f_alt "A Drawing called Hades and Persephone by Eduard Trewendt, 1864, showing a king and a queen in togas sitting on a throne, holding hands, with a 3-headed dog by their feet" :layout 'single-alphabet-superset'
...
:EXPORT_FEATURED_IMAGE: :featured_image /img/featured_D.webp :f_alt "Georges Seurat -- The Lighthouse at Honfleur, 1886. A painting of a shore with a building and a lighthouse in the distance. Small specks in the sky as birds are added. " :layout 'single-alphabet-superset'
