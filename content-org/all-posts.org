...
I have always been a note-taker. I feel a strong urge to capture thoughts, events and ideas that are important to me. Over the years, I have been using a bunch of apps, paper notebooks, different kinds of files and folder systems to try to keep some order in my notes. However hard I tried though, it always ended up being a mess, sooner or later. I think I sort of accepted that at some point as an inevitable part of life. That notes were temporary -- only good for helping me acquire the knowledge, but useless for long term storage. Now all of that changed with Zettelkasten.

*** What is a Zettelkasten
If you know what a Zettelkasten is, then by gods, just skip this part, because you have read it a million times.

The word Zettelkasten comes from German and means "slip box". Initially, that is exactly what it was, a filing cabinet full of paper slips for storing information, and it wasn't a particularly unusual thing to have before the time of computers. It was simply a way of storing notes written on small cards.

Zettelkasten as most people talk about it today has been popularised thanks to the work of Niklas Luhmann, a 20th century German sociologist who built a Zettelkasten of about 90,000 cards and used it to help him write over 50 books and 550 articles. He also wrote a book about his practice, called Communication with Zettelkästen (that is plural for Zettelkasten).
...
Thankfully, an actual filing cabinet is not necessary for making a Zettelkasten anymore. Instead, it can be completely digital. What makes a bunch of files into a Zettelkasten, is 3 basic principles.
...
2. Links between notes
   This is were the magic happens. You make links between notes by referencing them. It's sort of like a wiki, but with atomic notes. This way, it is possible to link to one note from many other notes, making connections between loads of different ideas.
...
*** Implementation
To make a Zettelkasten work, you need a unique adress/identifier for each note. These can be alphanumeric sequences in the style of Luhmann, or simple datetime identifiers. With a lot of modern software solutions, it is even enough with the titles of the notes, as long as they are unique. (There are reasons for and against the use of plain titles only and the debate is heated and I will not go into it.)
