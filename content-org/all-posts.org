...
** TODO Goodbye Zettelkasten. I quit.
:PROPERTIES:
:EXPORT_FILE_NAME: goodbye-zettelkasten
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :featured_image /img/featured_goodbye-zettelkasten.jpg :f_alt " " :bsky "https://bsky.app/profile/nori-pareli.bsky.social/post"
:EXPORT_DATE: 2025-0421
:EXPORT_HUGO_TAGS: Productivity "Mental health" Creativity
...
It's a system that allows me to think through my thoughts and note down the things that I want to remember in a place where I can find it later. It has just enough friction for me not to over-collect, but not too much so as to stop me from using it or to make it a chore. There is little to no overhead.
