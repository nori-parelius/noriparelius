...
Memex -- short for memory expander -- is a fictional machine from a 1945-book "As we may think" by Vannevar Bush. Memex organises a user's thoughts and semi-automatically brings related ideas together. A number of bloggers were inspired by memex, among them one of my favourites -- Cory Doctorow ([[https://pluralistic.net/2021/05/09/the-memex-method/][his blog post about The Memex Method]]). 
Memex might be fictional, but Zettelkasten does what memex sets out to do. It is a way to organise one's thougths and provide a framwork for connecting them. 
...
3. Keep it simple
   A principle on its own, but also a consequence of the previous too. Keeping it simple to make it as easy to make notes, maintain the system, move it to a different software and so on.
