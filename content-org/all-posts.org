...
** TODO My 5 reasons for blogging
:PROPERTIES:
...
:EXPORT_DATE: 2023-12-13
:EXPORT_HUGO_TAGS: Online "About me" "Knowledge work"
:EXPORT_HUGO_CATEGORIES: "Knowledge work" Blogging
:END:
...
I think a bunch. This is not a brag, by the way, I have no idea if I think more than others, and I am definitely not so certain this is good for me. But the fact is that I think enough for it to often get crowded in my head.
...
While thinking itself can be passive, writing, on the other hand, is active. It gives the thoughts a concrete form, turns them from possibilities into /things/. 
...
Richard Feynman was a big proponent of learning by trying to explain things to others, finding out where he lacked knowledge, looking up what was missing and then doing it all over again until he was satisfied. The Feynman technique (that is really what it is called) is just one of many within the "learning by teaching" framework. Even explaining things to an inanimate object improves learning, hence the existence of the "plastic platypus learning" technique. (Now I kind of want a plastic platypus.)
...
Does every teenager want to become a writer? I used to think so, then I asked a few people, and found out they don't. But I did. I also thought it was one of those silly dreams that you better not think too much about. How dumb is that?! Well, I finally got old enough and wise enough to realise that I might never be a /writer/, but there is nothing stopping me from being a writer. Nothing other than myself. 
...
I feel like the story works perfectly well with both photography and pottery, and the two versions of it illustrate how universal it actually is. Quantity doesn't trump quality, but it does lead to.
...
I often doubt whether what I am writing makes any sense, whether anyone wants to read it all, whether I should just give up and climb under a rock. But life is too short and weird for self-censorship, so I am doing my best to work around those doubts.
...
Now that I am thinking about it, my blogging already turned a distant acquaintance into one of my now best friends. (Shoutout to Maris!) I don't see where and how we would have gotten to know each other if I didn't step out of my comfort zone and started writing. 

*** What I didn't mention
An attentive reader might notice that I didn't talk about a few things that many people nowadays aim for when starting a blog. Namely money (and maybe fame). Now, I am not particularly interested in getting famous, but who would say no to extra money, right? Truth is, the last blog before this one was my attempt to start an online business. And I hated it. It was fun at first, then it wasn't. I wrote a whole [[{{< ref "/post/i-failed-at-starting-an-online-business" >}}][blog post about how I failed at starting an online business, and why I'm happy with that]]. I still think it's super neat that people can make money online and I definitely believe that creators should be paid for what they do and provide. But the way I was trying to go about it just didn't feel right for me.
