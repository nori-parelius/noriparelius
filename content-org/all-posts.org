...
** TODO My year with a Zettelkasten
:PROPERTIES:
...
Sonke Ahrens brought new attention to the Zettelkasten method in his [[https://www.soenkeahrens.de/en/takesmartnotes#zettelkasten-en][book How to Take Smart Notes]], where he explaines what a Zettelkasten is and how to use it.
...
Instead of trying to organize notes hierarchically into hard to navigate folders, all of my notes are in a single folder. Instead of trying to write notes as comprehensive as possible, each note is dedicated to one thought -- one idea, that I try to capture as best I can in the title. 
...
Memex -- short for memory expander -- is a fictional machine from a 1945-book "As we may think" by Vannevar Bush. Memex organizes a user's thoughts and semi-automatically brings related ideas together. A number of bloggers were inspired by memex, among them one of my favourites -- Cory Doctorow ([[https://pluralistic.net/2021/05/09/the-memex-method/][his blog post about The Memex Method]]). 
Memex might be fictional, but Zettelkasten does what memex sets out to do. It is a way to organize one's thougths and provide a framwork for connecting them. 
...
For me, reading books has become so much more intentional. That is where the majority of my Zettelkasten inputs come from. 
I find it especially useful when I know what output I want from my thinking. In my case, it's often blogging. (Although truth be told, most of what I want to blog about is still in my Zettelkasten/head.) Reading books has become so much more intentional

*** My journey with a Zettelkasten


It took me a few months to set things up in a way I like them from the technical point of view, but how I am taking notes, what I write and what I leave out, how I link them and how I structure them is still a work in progress. And probably always will be. 

No more folder trees
