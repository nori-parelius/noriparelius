...
1.  **Reminders** They serve as a reminder of what you have set out to do, so that you do not forget about it.
2.  **Motivation** They are meant to work as motivation. "You will not want to break your streak!" I have heard/read so many times. (Spoiler alert: that one didn't work for me.)
3.  **Overview** They give you an overview of how well you did sticking to your habit, so that you can fix and tweak things if it isn't going the way you want it to.
