...
- Section properties
  ...
  - EXPORT_SECTION - name of the folder to create and slug to add

- Page properties
  - Title - the title
  - EXPORT_FILE_NAME - file name of the page and its slug
  - EXPORT_FEATURED_IMAGE - address of featured image
  - EXPORT_FEATURED_ALT
  - EXPORT_DATE
  - EXPORT_LAYOUT
  - DESCRIPTION - html to be included as description in the html head, in listings above the cut and in RSS feed
  - tags 
  - todo state - also inherited in the tree
...
* CODE
** nori-site
#+begin_src elisp :noweb strip-export :tangle nori-site.el
;; -*- lexical-binding: t -*-
(require 'org)
(require 'ox-html)
...
#+begin_src elisp :noweb strip-export
<<traverse-ast-for-index>>
<<add-listings-data-to-index>>
...
*** Extract headline meta
#+name: extract-headline-meta
#+begin_src elisp
...
*** Add listings data to index
#+name: add-listings-data-to-index
#+begin_src elisp :noweb strip-export
<<gather-items>>
...
#+RESULTS: generate-rss
: nori-site--generate-rss
** Generate sitemap
...
** Main
#+begin_src html
;;:tangle "/home/nori/Documents/noriparelius/templates/post.html"
...
<main class="main-content">
  ...
  <div class="main-content-wrapper">
	...
	<div class="currently-reading">
	  ...
	  <p>
	    <ul>
	      <li>Ovid &ndash; Metamorphoses</li>
	    </ul>
	  </p>
	</div>
	<a class="microblog-latest-link" href="/microblog/2026/">
...
** RSS feed
#+begin_src xml :tangle  "/home/nori/Documents/noriparelius/templates/rss.xml"
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    <title>Posts on nori parelius</title>
    <link>https://www.noriparelius.com/post/</link>
    <description>Recent posts on nori parelius</description>
    <image>
      <url>https://www.noriparelius.com/img/noriparelius.png</url>
      <title>noriparelius.com</title>
      <link>https://www.noriparelius.com</link>
    </image>
    <language>en</language>
    <managingEditor>nori@noriparelius.com (Nori Parelius)</managingEditor>
    <webMaster>nori@noriparelius.com (Nori Parelius)</webMaster>
    <lastBuildDate>{{LAST_BUILD_DATE}}</lastBuildDate>
    <atom:link href="https://www.noriparelius.com/post/index.xml" rel="self" type="application/rss+xml"/>
    {{RSS_LIST}}
  </channel>
</rss>
#+end_src
** RSS feed item
#+begin_src xml :tangle  "/home/nori/Documents/noriparelius/templates/rss-item.xml"
<item>
  <title>{{ITEM_TITLE}}</title>
  <enclosure url="{{ITEM_FULL_FEATURED_IMAGE}}" type="image/{{IMAGE_EXT}}" length="{{IM_SIZE}}"></enclosure>
  <link>{{ITEM_CANONICAL_URL}}</link>
  <pubDate>{{ITEM_DATE_RFC822}}</pubDate>
  <author>nori@noriparelius.com (Nori Parelius)</author>
  <guid>{{ITEM_CANONICAL_URL}}</guid>
  <description>
    <![CDATA[
	     <img src="{{ITEM_FULL_FEATURED_IMAGE}}" width="800" height="150" />
	     {{ITEM_CONTENTS}}
    ]]></description>
</item>
#+end_src
...
#+end_src
** Comments
:tangle "/home/nori/Documents/noriparelius/templates/comments.html"
#+name: comments
#+begin_src html
...
#+begin_src html :tangle "/home/nori/Documents/noriparelius/templates/poem-listing-item.html"
...
#+begin_src html :tangle "/home/nori/Documents/noriparelius/templates/summary-with-image-item.html"
...
#+begin_src html :tangle "/home/nori/Documents/noriparelius/templates/microblog-listing-item.html"
...
#+begin_src html :tangle "/home/nori/Documents/noriparelius/templates/default-listing-item.html"
...
** Tangle templates
*** home
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/home.html"
<<head>>
  <<header>>
    <<home-main>>
      <<sidebar>>
...
#+end_src
*** post
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/post.html"
<<head>>
  <<header>>
    <<post-main>>
      <<sidebar>>
...
*** poem
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/poem.html"
<<head>>
  <<header>>
    <<poem-main>>
      <<sidebar>>
...
#+end_src
*** alphabet-superset
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/alphabet-superset.html"
<<head>>
  <<header>>
    <<as-main>>
      <<sidebar>>
...
#+end_src
*** microblog
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/microblog.html"
<<head>>
  <<header>>
    <<microblog-main>>
      <<sidebar>>
...
#+end_src
*** 404
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/404.html"
<<head>>
  <<header>>
    <main class="main-content">
      <div class="spiral"></div>
...
#+end_src
*** poem-section
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/poem-section.html"
<<head>>
  <<header>>
    <<poem-list-main>>
      <<sidebar>>
...
#+end_src
*** as-section
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/as-section.html"
<<head>>
  <<header>>
    <<post-list-main>>
      <<sidebar>>
...
#+end_src
*** post-section
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/post-section.html"
<<head>>
  <<header>>
    <<post-list-main>>
      <<sidebar>>
...
#+end_src
*** microblog-section
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/microblog-section.html"
<<head>>
  <<header>>
    <<microblog-list-main>>
      <<sidebar>>
...
#+end_src
*** poem-section
#+begin_src html :noweb strip-export :tangle "/home/nori/Documents/noriparelius/templates/default-section.html"
<<head>>
  <<header>>
    <<default-list-main>>
      <<sidebar>>
...
* CSS
** Base
#+begin_src scss :tangle ~/Documents/noriparelius/css-raw/style.scss
/* Pressed flower flourish (optional) 
.flower-corner {
  position: absolute;
  top: 1rem;
  right: 1rem;
...
/* Gentle highlight (e.g. like ink or smudge) */
.highlight-block {
...
#+begin_src scss :tangle ~/Documents/noriparelius/css-raw/style.scss
// === FONTS ===
//@import url('https://fonts.googleapis.com/css2?family=Special+Elite&family=Caveat&family=Crimson+Pro&display=swap');
...
:root {
    //=== COLORS ===
    --bg-paper: #fdfaf6; /* linen white */
    --text-main: #2e2e2e;
    --text-subtle: #7c6f60; /* dusty sepia */
    --ink-brown: #5c4a3d; /* primary accent */
    --rosewood: #a37c6c; /* secondary accent */
    --frame: #d1c7b7; /* weathered parchment, for boxes */
    
    --sidebar-bg: #fcf3e8; /* faded apricot */
    --highlight: #7e8c87; /* muted sage green for hovers */
    /* optional ink/pencil for headers, washi, annotation*/
    --ink-stain: #5c6b73;
    --graphite: #4a4a4a;
    --pencil-grey: #78736d;
    /* washis */
    --pale-ochre: #f4e6c1;
    --dusty-rose: #ddb7ab;
    --faded-cornflower: #9caeb7; 
    --pale-mint: #cddbd2;
}
@media (prefers-color-scheme: dark) {
    :root {
	// === COLORS ===
	--bg-paper: #2e2e2e; /* linen white */
	--text-main: #fdfaf6;
	--text-subtle: #e4e2df; /* dusty sepia */
	--ink-brown: #bcb6b1; /* primary accent */
	--rosewood: #b59689; /* secondary accent */
	--frame: #68635b; /* weathered parchment, for boxes */
	--sidebar-bg: #3b2408; /* faded apricot */
	--highlight: #7e8c87; /* muted sage green for hovers */
	/* optional ink/pencil for headers, washi, annotation*/
	--ink-stain: #5c6b73;
	--graphite: #c8c8c8;
...
@media (prefers-reduced-motion: no-preference) {
    .site-logo-link:hover .site-logo-wrapper {
...
.site-title-link::after {
    ...
    width: 100%;
    height: 20px;  /* match your underline height */
...
@media (min-width: 850px) {
	...
	/* two rows so that sidebar has a top and bottom */
    ...
    .menu-section, .sidebar-extras-section {
	padding: 1rem 0 0 0;
    }
    ...
    .sidebar-extras-section { grid-area: extras; }
...
.site-container::after {
    ...
    width: 70px;
    height: 70px;
    background-image: url('/img/pressed_flower_3.png');
...
.sidebar-archive {
   ...
   ,*/
    border: solid 1px var(--pencil-grey);
...
.sidebar-widgets2 {
    ...
    display: block;
    background-color: var(--bg-paper);
    background-image: url('/img/grid-paper.jpg');
    background-size: auto;
    background-repeat: repeat;
    background-blend-mode: multiply;
    box-shadow: 0px 0px 12px rgba(0,0,0,0.15);
...
.sidebar-widgets2::after {
    ...
    width: 80px;
    height:80px;
    background-image: url('/img/pressed_flower_1.png');
    background-size: contain;
    background-repeat: no-repeat;
    opacity: 1;
    pointer-events: none;
...
.tape {
    background-color: hsla(14.4,30%,50%,.2); //hue, saturation, lightness, alpha orig (0,0%, 100%,.2)
    box-shadow: inset 0 0 1em .5em hsla(14.4,30%,50%,.1); //inset puts the shadow in
    height: 3em;
    width: 10em;
    position: absolute;
...
// tape edges
// two gradients crossing at 45 and -45 deg, create a repeating zig-zag of transparent vs white
// placed slightly outside with left:
.tape:after,
.tape:before {
...
.tape:after {
    background-image: linear-gradient(45deg, transparent 50%, hsla(14.4,30%,50%,.3) 50%),
                      linear-gradient(-45deg, transparent 50%, hsla(14.4,30%,50%,.3) 50%);
    background-position: 0 100%;
    left: -.2em;
}
.tape:before {
    background-image: linear-gradient(135deg, transparent 50%, hsla(14.4,30%,50%,.3) 50%),
                      linear-gradient(-135deg, transparent 50%, hsla(14.4,30%,50%,.3) 50%);
...
.tagcloud a:nth-of-type(5n+1) { transform: rotate(-2.5deg); }
.tagcloud a:nth-of-type(3n+3) { transform: rotate(1deg); }
.tagcloud a:nth-of-type(3n+4) { transform: rotate(-4deg); }
.tagcloud a:nth-of-type(5n+5) { transform: rotate(3deg); }
...
.flower-link {
    position: absolute;
    top: 0rem;
    right: -3rem; /* pushes it into the margin */
    width: 90px; 
    opacity: 0.85;
    transition: opacity 0.3s ease;
}
...
.flower-link img {
    ...
    height: auto;
    display: block;
    pointer-events: none; /* ensures only the <a> is clickable */
}
...
.top-footer::after {
    ...
    width: 120px;
    height:120px;
    background-image: url('/img/stamp-nobg.png');
    background-size: contain;
    background-repeat: no-repeat;
    opacity: 1;
    pointer-events: none;
...
.site-nav ul {
    position: relative;
    background-color: var(--pale-ochre);
...
** Single article
#+begin_src scss :tangle ~/Documents/noriparelius/css-raw/style.scss
/* === Article: main content of a single === */
.single-article {
    display: flex;
    flex-direction: column;
}
...
.single-article .section-title a {
...
.single-article .section-title a:hover {
    text-decoration: underline;
    color: var(--highlight);
}
...
#load-comments {
    ...
    font-family: 'Special Elite';
    background-color: var(--pale-ochre);
    border: 1px solid var(--pale-ochre);
    border-radius: 10px;
...
.year-panel {
    ...
    border-radius: 5px;
    border-left: 12px solid var(--dusty-rose);
...
.pagination .page-item.active .page-link {
    background-color: var(--faded-cornflower);
    font-weight: bold;
    pointer-events: none;
}
...
.pagination-subtle .page-link-subtle {
    color: var(--rosewood);
    text-decoration: none;
}


.pagination-subtle .page-link-subtle:hover {
    color: var(--inkbrown);
    text-decoration: underline;
}
...
.prev,
.next {
    border-bottom: 1px dashed var(--rosewood);
}
...
.micro-section::after {
    ...
    width: 120px;
    height: 120px;
    background-image: url('/img/inkstain.png');
    background-size: contain;
    background-repeat: no-repeat;
    opacity: 0.1;
    pointer-events: none;
...
.micro-section-title {
    text-align: center;
    margin-bottom: 2rem;
    border-bottom: 3px dashed var(--frame);
    padding-bottom: 0.5rem;
}
...
** Poem
#+begin_src scss :tangle ~/Documents/noriparelius/css-raw/style.scss
/* ~~~~~~ poems/section.html and poems/single.html ~~~~~~ */
...
.individual-list-item h2 {
    margin: 0;
    padding: 0;
}

.individual-list-item a {
    color: var(--rosewood);
    font-size: 1.2rem;
    text-decoration: none;
}

.individual-list-item a:hover {
    text-decoration: underline;
}
...
.single-poem .section-title a:hover {
    text-decoration: underline;
    color: var(--highlight);
}

.default-section .section-title a {
    text-transform: uppercase;
    color: var(--text-subtle);
    margin-bottom: 1rem;
    padding: 1rem;
...
.default-section .section-title a:hover {
    text-decoration: underline;
    color: var(--highlight);
}
...
/* === Article: main content of the homepage === */
.main-article-home {
    font-family: 'Caveat';
    font-size: 1.2rem;
...
@media (prefers-color-scheme: light) {
    .main-article-home {
	background-image: url('/img/washi-tape-rosewood.png');
	background-size: cover;
	background-repeat: no-repeat;
...
.about-me {
    ...
    justify-content: center;
    align-items: center;
    border-radius: 50px 180px 70px 300px/300px 50px 300px 70px;
    border: solid 1px var(--pencil-grey);
}
...
.about-me-pic img {
    width: 200px;
    border-radius: 50px;
    border: solid 3px var(--frame);
    box-shadow: 4px 4px 20px rgba(0,0,0,0.2);
}

.currently-reading-and-microblog {
    display: flex;
    flex-direction: row;
    flex-flow: wrap;
    margin: 1rem auto;
...
.featured-image-preview-im-link:hover .featured-image-preview-section {
    box-shadow: 2px 4px 12px rgba(0,0,0,0.6);
}
...
.preview-summary-div h2 {
    padding: 1rem;
    margin: 0;
}

.preview-summary-div .meta {
    padding: 0 1rem;
    margin: 0;
    font-size: 1rem;
    color: var(--text-subtle);
...
.preview-summary-div .meta a {
    color: var(--text-subtle);
}

.preview-summary-link-text div {
    margin: 0rem 1rem;
}

.preview-summary-link-text p {
    padding: 0;
}

.preview-summary-link-header {
    color: var(--ink-brown);
    text-decoration: none;
}

.preview-summary-link-text,
.preview-summary-link-text:hover {
    color: var(--text-main);
    text-decoration: none;
}
...
(nori-site--make-site nori-site--contents-org-filename t)
#+end_src
...
(let* ((org-buffer (find-file-noselect  nori-site--contents-org-filename))
...
;(let (( posts (nori-site--get-all-posts-from-org nori-site--contents-org-filename nil)))
;  posts)
#+end_src
