...
<<add-listings-data-to-index>> ;; needs gather items
...
<html lang="{{LANGUAGE_CODE}}" dir="ltr">
  ...
  <head>
    ...
    <!-- RSS feed link -->
    <link rel="alternate" type="application/rss+xml" title="Posts on noriparelius" href="https://www.noriparelius.com/post/index.xml">
	
    <!-- Load css and js -->
    <link rel="stylesheet" href="/css/style.css">
    
    <!-- Alceris-->
    <script src="https://alceris.com/script.js" data-id="8af49cc181625f3e" async defer></script>
...
<div class="badges-row">
  <div>
    <a href="https://www.noriparelius.com" target="_blank">
      <img src="/img/badges/badge.png" alt="Mess & wonder - noriparelius.com" width="88" height="31">
    </a>
  </div>
  <div>
    <img src="/img/badges/madewithemacs2.png" alt="Made with Emacs" width="88" height="31">
  </div>
  <div>
    <img src="/img/badges/cookiefree.png" alt="Cookie-free" width="88" height="31">
  </div>
  <div class="tooltip">
    <img src="/img/badges/handmade.png" alt="Handmade" width="88" height="31">
  </div>
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <image>
      <url>https:img/noriparelius.png</url>
...
<item>
  ...
  <enclosure url="{{ITEM_FEATURED_IMAGE}}" type="image/{{IMAGE_EXT}}" length="{{IM_SIZE}}"></enclosure>
...
.badges-row {
    ...
    flex-direction: row;
    flex-wrap: wrap;
    background-image: url('/img/flower-border.png');
    background-size: contain;
