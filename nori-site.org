...
(defun test-entry-index ()
  <<entry-index>>
  (message "%s" nori-site--contents-org-filename)
...
#+RESULTS:
| tag/ | (file-name . _index) | (title . Tags) | (layout . default-section.html) | (page-size . 50) | (sections-names Tags) | (sections-slugs tag) | (section-slug . tag/) | (slug . tag/) | (file-path-dir . ~/Documents/noriparelius/public/tag/) | (file-path-file . ~/Documents/noriparelius/public/tag/index.html) | (list-items) | (list-all-items) | (f-image) | (f-alt) | (description) | (date) | (tags) | (wordcount) | (prev-item) | (next-item) |
...
#+begin_src elisp :noweb strip-export :tangle ~/Documents/noriparelius/render-site.el
<<variables>>
<<entry-index>>
<<subtree-to-html>>
<<generate-page>>
